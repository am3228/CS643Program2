...
public class Wine_Quality_Training {
    ...
    public static void printMetrics(Dataset<Row> predictions) {
        System.out.println();
    ...
    public static void logisticRegressionModel(SparkSession spark) throws IOException{
